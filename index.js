var Contact = /** @class */ (function () {
    function Contact(fullName, email, phone) {
...
var AddressBook = /** @class */ (function () {
    ...
    AddressBook.prototype.findContactByName = function (name) {
        return this.contacts.find(function (contact) { return contact.fullName === name; });
    };
    ...
    AddressBook.prototype.sortByName = function () {
        this.contacts.sort(function (a, b) { return a.fullName.localeCompare(b.fullName); });
    };
    // New functionalities:
    ...
    AddressBook.prototype.searchContacts = function (searchTerm) {
        ...
        return this.contacts.filter(function (contact) {
            return contact.fullName.toLowerCase().includes(normalizedSearchTerm);
        });
    };
    AddressBook.prototype.printContacts = function () {
        for (var _i = 0, _a = this.contacts; _i < _a.length; _i++) {
            var contact = _a[_i];
            console.log("Name: ".concat(contact.fullName));
...
searchResults.forEach(function (contact) { return console.log("  - ".concat(contact.fullName)); });
